...
Pakman: $(OUT_DIR)/main.o GameManager.o Agent.o utils.o Animation.o Maze.o Tile.o Pellet.o
	g++ $(OUT_DIR)/main.o $(OUT_DIR)/GameManager.o $(OUT_DIR)/Agent.o $(OUT_DIR)/utils.o $(OUT_DIR)/Animation.o $(OUT_DIR)/Maze.o $(OUT_DIR)/Tile.o $(OUT_DIR)/Pellet.o -o $(OUT_DIR)/Pakman $(SFMLFLAGS)
