...
Pakman: $(OUT_DIR)/main.o GameManager.o MainMenuState.o PlayState.o GameOverState.o Entity.o Character.o Pakman.o utils.o Animation.o Maze.o Tile.o Pellet.o
	g++ $(OUT_DIR)/main.o $(OUT_DIR)/GameManager.o $(OUT_DIR)/MainMenuState.o $(OUT_DIR)/PlayState.o $(OUT_DIR)/GameOverState.o $(OUT_DIR)/Character.o $(OUT_DIR)/Entity.o $(OUT_DIR)/Pakman.o $(OUT_DIR)/utils.o $(OUT_DIR)/Animation.o $(OUT_DIR)/Maze.o $(OUT_DIR)/Tile.o $(OUT_DIR)/Pellet.o -o $(OUT_DIR)/Pakman $(SFMLFLAGS)
